#1.1.7 - commented out unnecesary constants, corrected a variable error, made wales work if you clicked calculate straight away
...
# UI	
ui <- bslib::page_fluid(
  titlePanel("Resident Doctor Pay Uplift Calculator - England/Wales 25/26 v1.1.7"),
  sidebarLayout(
    sidebarPanel(
      width = 4,
# Country selector
radioButtons(
  "nation", "Where do you work? (as of v1.1.7 only England and Wales work)",
